...
const LoginScreen = (props: any) => {
    ...
    const onLogin = () => {
        ...
        if (validate()) {
            dispatch({type: actions.LOGIN_ACCOUNT, payload: {phone, password}})
        }
        ...
        <>
            ...
            <LinearGradient
                ...
                <Animated.View style={[styles.content, { transform: [{ ...{ translateY } }] }]}>
                    ...
                    <GradientButton onPress={onLogin} >Đăng Nhập</GradientButton>
                    <StrokeButton onPress={()=>navigate('RegisterScreen', {})} >Đăng Ký</StrokeButton>
